<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html>
	<html>
	<head>
		<title>招聘信息-<?php echo ($site_name); ?> </title>
	...
	<div class="row">
		<div class="span9">
			...
			<div class="tc-box first-box article-box">
		    	<h2><b style="font-size:27px;">|</b><a href="<?php echo U('index');?>"style="color:black;text-decoration:none;">您当前的位置</a>&gt;&gt;<?php echo ($name); ?></h2>
		    	...
		    	<hr>	  
		  <tr>
<h4 style="font-size:20px;text-align:center;">&nbsp;招聘信息&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<hr>
 ...
 <?php $at=sp_sql_posts('cid:21;field:post_title,post_modified,post_content,tid,smeta,post_excerpt;order:post_modified desc;'); ?>
 <?php if(empty($at)): ?><div style="text-align:center;color:red;font-size:22px;font-family:宋体;margin-top:60px;"> <script>alert('不好意思,暂时没有招聘信息！！！');</script>不好意思,暂时没有招聘信息!!!!</div>
 <?php else: ?>
  <?php if(is_array($at)): $i = 0; $__LIST__ = $at;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div style="float:left;width:670px;">
  <img src="/thinkcmf/themes/simplebootx/Public/images/2.png" alt="">
                                <a href="<?php echo leuu('portal/article/index',array('id'=>$vo['tid'],'cid'=>$vo['term_id']));?>" target='_blank'style="text-decoration:none;"><?php echo ($vo["post_title"]); ?></a>
                            </div>
                            <div style="float:left;"><?php echo ($vo["post_modified"]); ?></div>
                             <p style="clear:both;"></p><?php endforeach; endif; else: echo "" ;endif; endif; ?>
                        </div>
                    </div>
