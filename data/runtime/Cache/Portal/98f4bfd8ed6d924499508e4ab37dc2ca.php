				...
				<div class="span9">
					<table class="table table-bordered">
						...
						<tr>
							<th>摘要</th>
							<td>
								<textarea name="post[post_excerpt]" required style="width: 98%; height: 50px;" placeholder="请填写不少于50字的文章摘要"><?php echo ($post["post_excerpt"]); ?></textarea>
								<span class="form-required">*</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div style="text-align: center;">
									...
									<a href="javascript:void(0);" onclick="flashupload('thumb_images', '附件上传','thumb',thumb_images,'1,jpg|jpeg|gif|png|bmp,1,,,1','','','');return false;">
										<?php if(empty($smeta['thumb'])): ?><img src="/thinkcmf/admin/themes/simplebootx/Public/assets/images/default-thumbnail.png" id="thumb_preview" width="135" style="cursor: hand"/>
										<?php else: ?>
