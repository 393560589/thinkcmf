...
<div class="container tc-main">
	<div class="row">
		<div class="span9">
			...
			<?php if(is_array($va)): $i = 0; $__LIST__ = $va;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><h2><b style="font-size:27px;">|</b>您当前的位置是&gt;&gt;<?php echo ($vo["post_title"]); ?></h2>
		    	<div class="article-infobox">
		    		<!-- <span><?php echo ($vo["post_date"]); ?> by <?php echo ((isset($vo["user_nicename"]) && ($vo["user_nicename"] !== ""))?($vo["user_nicename"]):$vo.user_login); ?></span> -->
		    		<span>
