		...
		<div class="span9">
			...
			<div class="tc-box first-box article-box">
		    	...
		    	<div class="article-infobox">
		    		...
		    		<span>
		    			<a href="javascript:;" style="text-decoration:none;"><!-- <i class="fa fa-eye"></i> -->浏览次数:<span><?php echo ($post_hits); ?></span></a>
						<!-- <a href="<?php echo U('article/do_like',array('id'=>$object_id));?>" class="js-count-btn"><!-- <i class="fa fa-thumbs-up"></i> --><!-- 点赞数:<span class="count"><?php echo ($post_like); ?></span></a> --> 
