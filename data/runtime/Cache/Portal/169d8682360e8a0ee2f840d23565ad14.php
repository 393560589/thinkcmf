...
<body>
					...
					<table class="table table-bordered">
						<tr>
							...
							<td>
								...
								<div>友情提示：按住 Ctrl 按钮来选择多个选项</div>
							</td>
						</tr>
						<tr>
							<th>标题</th>
						...
						<tr>
							<th>摘要</th>
							<td>
								<textarea name="post[post_excerpt]" id="description" required style="width: 98%; height: 50px;" placeholder="请输入不少于50字的摘要,可以将文章的第一段的前几句话复制到摘要中"></textarea>
									<span class="form-required">*</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div style="text-align: center;">
									...
									<a href="javascript:void(0);" onclick="flashupload('thumb_images', '附件上传','thumb',thumb_images,'1,jpg|jpeg|gif|png|bmp,1,,,1','','','');return false;">
										<img src="/thinkcmf/admin/themes/simplebootx/Public/assets/images/default-thumbnail.png" id="thumb_preview" width="135" style="cursor: hand" />
									</a>
									<input type="button" class="btn btn-small" onclick="$('#thumb_preview').attr('src','/thinkcmf/admin/themes/simplebootx/Public/assets/images/default-thumbnail.png');$('#thumb').val('');return false;" value="取消图片">
								</div>
							</td>
						</tr>
						<tr>
	...
	<script type="text/javascript" src="/thinkcmf/public/js/content_addtop.js"></script>
	<script type="text/javascript">
		//编辑器路径定义
		var editorURL = GV.DIMAUB;
	</script>
	<script type="text/javascript" src="/thinkcmf/public/js/ueditor/ueditor.config.js"></script>
	<script type="text/javascript" src="/thinkcmf/public/js/ueditor/ueditor.all.min.js"></script>
	<script type="text/javascript">
		$(function() {
