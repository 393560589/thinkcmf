<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html>
	...
	<style>
		...
		<style>
			#article_content img{height:100px; !important}
			#article_content {word-wrap: break-word;height:700px;}
	...
	<div class="row">
		<div class="span9">
			...
			<div class="tc-box first-box article-box">
		    	<h2><b style="font-size:27px;">|</b>您当前的位置&gt;&gt;<?php echo ($newname); ?></h2>
...
<?php $a=sp_sql_posts('cid:8;field:post_title,post_modified,post_content,smeta,post_excerpt,tid;order:post_modified desc;'); ?>
						    <?php if(is_array($a)): $i = 0; $__LIST__ = $a;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div style="float:left;width:670px;">
                                <img src="/thinkcmf/themes/simplebootx/Public/images/2.png" alt="">
                               <a href="<?php echo U('portal/article/index',array('id'=>$vo['tid'],'cid'=>$vo['term_id']));?>" target='_blank'><?php echo ($vo["post_title"]); ?></a>
                            </div>
